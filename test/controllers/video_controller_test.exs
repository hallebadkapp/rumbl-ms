defmodule Rumbl.VideoController_Test do
  use Rumbl.ConnCase
  alias Rumbl.Video
  ...
  @tag login_as: "max"
  test "does not create a video and renders error when invalid", %{conn: conn} do
  ...
  @tag login_as: "max"
  test "auhtorizes actions against access by other users",
